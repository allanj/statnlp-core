 ...
 */
public class CustomStackVertex extends BaseGraphVertex {

    public CustomStackVertex(ComputationGraph graph, String name, int vertexIndex) {
        this(graph, name, vertexIndex, null, null);
    }

    public CustomStackVertex(ComputationGraph graph, String name, int vertexIndex, VertexIndices[] inputVertices,
    ...
    public Pair<Gradient, INDArray[]> doBackward(boolean tbptt) {
        ...
        if (epsilon == null) return new Pair<>(null, out);
