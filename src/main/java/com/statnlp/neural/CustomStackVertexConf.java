 ...
 */
public class CustomStackVertexConf extends GraphVertex {

    public CustomStackVertexConf() {}

    @Override
    public CustomStackVertexConf clone() {
        return new CustomStackVertexConf();
    }

    @Override
    public boolean equals(Object o) {
        return o instanceof CustomStackVertexConf;
    }
    ...
    public org.deeplearning4j.nn.graph.vertex.GraphVertex instantiate(ComputationGraph graph, String name, int idx,
        ...
        return new CustomStackVertex(graph, name, idx);
    }
