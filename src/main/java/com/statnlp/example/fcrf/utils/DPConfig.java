package com.statnlp.example.fcrf.utils;
...
//	public static String trainingPath = "data/"+dataType+"/small.txt";
	...
	public static String linear_ner_eval_suffix =".linearner.eval.txt"; 
	public static String linear_ner_bothMarginal_eval_suffix =".bothMarginal.eval.txt"; 
