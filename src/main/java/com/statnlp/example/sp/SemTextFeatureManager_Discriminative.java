...
//	private int historySize;
	...
	// idx is current pos in the array fs
	// create features according to the neural-related flags
	// subsequent assignments fs[idx] = ... will be replaced by this
	private int createEmissionNeuralFeatures(Network network, int[] fs, int idx, String output, String input) {
		int t = idx;
		if (NetworkConfig.USE_NEURAL_FEATURES) {
			// if this flag is false, we include original emission features
