...
------------------------------------------------------------------------
local PyTorchFastLSTM, parent = torch.class("PyTorchFastLSTM", "nn.LSTM")

-- set this to true to have it use nngraph instead of nn
-- setting this to true can make your next PyTorchFastLSTM significantly faster
PyTorchFastLSTM.usenngraph = false
PyTorchFastLSTM.bn = false

function PyTorchFastLSTM:__init(inputSize, outputSize, rho, eps, momentum, affine, p, mono)
   -- when PyTorchFastLSTM.bn=true, the default values of eps and momentum are set by nn.BatchNormalization
   self.eps = eps
...
function PyTorchFastLSTM:nngraphModel()
...
function PyTorchFastLSTM:buildGate()
   error"Not Implemented"
end

function PyTorchFastLSTM:buildInputGate()
   error"Not Implemented"
end

function PyTorchFastLSTM:buildForgetGate()
   error"Not Implemented"
end

function PyTorchFastLSTM:buildHidden()
   error"Not Implemented"
end

function PyTorchFastLSTM:buildCell()
   error"Not Implemented"
end

function PyTorchFastLSTM:buildOutputGate()
   error"Not Implemented"
end